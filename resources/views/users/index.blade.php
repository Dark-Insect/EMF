                            ...
                            <div class="card border-top border-0 border-4 border-primary">
                                <div class="card-body p-5">
                                    ...
                                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="col-6">
                                            <label for="inputChoosePassword" class="form-label">User Controls and Authority
                                            </label>
                                            <select name="is_admin" id="" class="form-select" required>
                                                <option>Select User Type</option>
                                                <option value="1" {{old('is_admin') == "1" ? 'selected' : ''}}>Admin</option>
                                                <option value="2" {{old('is_admin') == "2" ? 'selected' : ''}}>Moderator</option>
                                                <option value="3" {{old('is_admin') == "3" ? 'selected' : ''}}>Guests</option>
                                            </select>

                                        </div>
                                        <div class="col-6">
                                            <label for="inputChoosePassword" class="form-label">Users Status
                                            </label>
